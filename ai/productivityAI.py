...
调整原则：当用户直接表达身体或情绪的强烈变化（如“发烧”“崩溃”“狂喜”）时，立即将对应维度拉到与表达一致的数值（范围 0-100，可跨越 40+），不要平滑过渡。日常杂谈微调 1-3 点。PHI由活力/情绪/关系/自我/意义的理想点(80/75/80/85/75)的均方根偏差计算，偏离即扣分(无论过高过低)，高分不代表高和谐；例如 90,80,95,99,90 → PHI≈35。
